...
pub(super) const PLACEMENTS: [PlacementMock; 6] = [
    PlacementMock {
        ...
        center_y: 0, layout: layout_type::FLOOR, direction: Direction::Front, fixture_id: 8,
    },
    PlacementMock {
