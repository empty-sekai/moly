...
use super::{Direction, GridPosition, PlacementMock, layout_type};
...
const SURFACES: [(&str, [i8; 3], i32); 16] = [
    ("mysekai__fixture__mdl_cst0005_canvas_large1board1", [5, 3, 1], 441),
    ("mysekai__fixture__mdl_cst0005_canvas_large1stand1", [2, 1, 1], 444),
    ("mysekai__fixture__mdl_cst0005_canvas_medium1board1", [3, 3, 1], 440),
    ("mysekai__fixture__mdl_cst0005_canvas_medium1stand1", [1, 1, 1], 443),
    ("mysekai__fixture__mdl_cst0005_canvas_small1board1", [1, 1, 1], 439),
    ("mysekai__fixture__mdl_cst0005_canvas_small1stand1", [1, 1, 1], 442),
    ("mysekai__fixture__mdl_env0001_fixture_tree1", [4, 5, 4], 471),
    ("mysekai__fixture__mdl_ext0020_fixture_pond1", [6, 3, 7], 1023),
    ("mysekai__fixture__mdl_non1002_after_conifer1", [3, 14, 3], 123),
    ("mysekai__fixture__mdl_non1002_after_hardwood1", [3, 14, 3], 122),
    ("mysekai__fixture__mdl_non1002_after_luxurytree1", [4, 14, 4], 125),
    ("mysekai__fixture__mdl_non1002_after_palmtree1", [3, 14, 3], 124),
    ("mysekai__fixture__mdl_non1004_fixture_shrub1", [2, 2, 2], 542),
    ("mysekai__fixture__mdl_non1004_fixture_shrub2", [2, 2, 2], 543),
...
const GIMMICKS: [(&str, [i8; 3], i32); 6] = [
    ("mysekai__fixture__mdl_ext0014_fixture_synthesizer1", [4, 2, 2], 297),
    ("mysekai__fixture__mdl_ext0014_fixture_guitar1", [2, 4, 2], 298),
    ("mysekai__fixture__mdl_ext0014_fixture_bass1", [2, 4, 2], 299),
    ("mysekai__fixture__mdl_ext0014_fixture_drum1", [5, 3, 4], 300),
    ("mysekai__fixture__mdl_chr0004_fixture_nenerobo1", [2, 3, 2], 423),
    ("mysekai__fixture__mdl_ext0002_fixture_fridge1", [2, 4, 2], 157),
];

#[cfg(target_arch = "wasm32")]
fn selection() -> Option<String> {
    let search = web_sys::window()?.location().search().ok()?;
    web_sys::UrlSearchParams::new_with_str(&search).ok()?.get("fixture_preview")
}
...
pub(super) fn append_preview(rows: &mut Vec<PlacementMock>) {
    ...
    let cells: &[(i8, i8, Direction)] = match layout {
        ...
        "line" => &[(-16, 14, Direction::Front), (-14, 14, Direction::Front), (-12, 14, Direction::Front)],
        "corner" => &[(-16, 14, Direction::Front), (-14, 14, Direction::Front), (-14, 16, Direction::Left)],
        "square" => &[(-16, 14, Direction::Front), (-14, 14, Direction::Front), (-16, 16, Direction::Front), (-14, 16, Direction::Front)],
        "cross" => &[(-16, 14, Direction::Front), (-14, 14, Direction::Front), (-12, 14, Direction::Front),
            (-14, 16, Direction::Left), (-14, 12, Direction::Left)],
    ...
    for &(x, z, direction) in cells {
        ...
        rows.push(PlacementMock {
            ...
            center_y: 0, layout: if road { layout_type::ROAD } else { layout_type::FLOOR },
            direction: if road { Direction::Front } else { direction }, fixture_id: 0,
        });
    }
